export default function Impressum() {
  return (
    <div className='w-full h-screen flex justify-center'>
      <div className='flex flex-col gap-4 text-center max-w-screen-lg mt-20'>
        ...
        <h4 className='text-lg'>Wie erfassen wir Ihre Daten?</h4>
        <p>
        ...
        <h4 className='text-lg'>Wof&uuml;r nutzen wir Ihre Daten?</h4>
        <p>
        ...
        <h2 className='text-2xl'>2. Hosting</h2>
        <p>Wir hosten die Inhalte unserer Website bei folgendem Anbieter:</p>
        <h3 className='text-xl'>Externes Hosting</h3>
        <p>
        ...
        <h3 className='text-xl'>Empfänger von personenbezogenen Daten</h3>
        <p>
        ...
        <h3 className='text-xl'>Auskunft, Berichtigung und L&ouml;schung</h3>
        <p>
        ...
        <h3 className='text-xl'>SSL- bzw. TLS-Verschl&uuml;sselung</h3>
        <p>
        ...
        <h2 className='text-xl'>4. Datenerfassung auf dieser Website</h2>
        ...
        <h3 className='text-xl'>Kontaktformular</h3>
        <p>
        ...
        <h3 className='text-xl'>Anfrage per E-Mail, Telefon oder Telefax</h3>
        <p>
